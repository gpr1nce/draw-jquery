var draw = (function() {
  // console.log('defining the Draw app as object/ function');
  ...
  var mWidth = document.querySelector('main').offsetWidth,
    ...
    //Create the canvas - log before/after
    // wasconsole.log('');
...
// here to getShape is all new Chad main js
//Set a random color
randColor: function(){
...
isDrawing = bool;
    ...
    // moooooooooooooved this way down here per Chad
    getShape: function() {
      return shape;
    },
    ...
    init: function() {
      ...
      document.getElementById('trackX').innerHTML = 'X: 0';
      document.getElementById('trackY').innerHTML = 'Y: 0';
    }
  };
...
draw.getCanvas().addEventListener('mousemove', function(evt) {
  // tested/withdrew requirement that isDrawing is true, to keep from moving coord vals before drawing; added to mouseleave event on canvas
    draw.setXY(evt);
    draw.writeXY();
...
// add mouseleave listener to reset x,y when cursor moves off canvas
draw.getCanvas().addEventListener('mouseleave', function() {
  document.getElementById('trackX').innerHTML = 'X: 0';
  document.getElementById('trackY').innerHTML = 'Y: 0';
// needed?
